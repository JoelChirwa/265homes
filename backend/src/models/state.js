...
export const listingsById = new Map([
  [
    "lst-1",
    {
      ...
      description: "Modern 2 bedroom apartment in a secure gated community.",
      ...
      isDeleted: false,
      createdAt: nowIso(),
      gps: { latitude: -13.9626, longitude: 33.7741 },
    },
  ],
  [
    "lst-2",
    {
      ...
      description: "Cozy bedsitter ideal for students or young professionals.",
      ...
      isDeleted: false,
      createdAt: nowIso(),
      gps: { latitude: -15.7861, longitude: 35.0058 },
    },
  ],
]);
